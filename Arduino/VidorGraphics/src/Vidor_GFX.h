...
class Vidor_GFX : public Print, public VidorIP {
  public:
    ...
    void fillRect(int32_t x, int32_t y, uint32_t w, uint32_t h, uint32_t color, uint8_t alpha=0xff);
    void fillRoundRect(int32_t x, int32_t y, uint32_t w, uint32_t h, uint16_t r, uint32_t color, uint8_t alpha=0xff);
    void drawRoundRect(int32_t x, int32_t y, uint32_t w, uint32_t h, uint16_t r, uint32_t color, uint8_t alpha=0xff);
    ...
    void runBenchmark(uint32_t flags);
    virtual size_t write(uint8_t c);
    using Print::write;
